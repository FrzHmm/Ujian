...
export class ViewPage {
  ...
  async sendToWhatssapp(){
    ...
    window.open (`https://api.whatsapp.com/send?phone=+6285888848553&text=${encodeURIComponent(pesan)}`,'_blank')
  }
  ...
  validateForm(){
    if (!this.ktpData.nama|| !this.ktpData.nik|| !this.ktpData.tempatLahir|| !this.ktpData.tanggalLahir || !this.ktpData.Alamat ) {
      return false 
    }
    return true
  }
